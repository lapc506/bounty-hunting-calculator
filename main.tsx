...
const App = () => {
  ...
  const removeBounty = (id) => setBounties(bounties.filter(b => b.id !== id));
        ...
        <header className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white p-6 rounded-3xl shadow-sm border border-slate-200">
          <div>
            <h1 className="text-3xl font-bold text-slate-900 flex items-center gap-2">
              <Cpu className={mode === 'agentic' ? "text-purple-600" : "text-slate-500"} /> 
              Agéntic Hunter OS
            </h1>
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className="bg-slate-900 rounded-3xl p-8 text-white relative">
              <div className="flex items-center justify-between mb-6">
                ...
                <button className="bg-slate-800 p-2 rounded-lg hover:bg-slate-700 transition-all">
                  <Copy size={18} />
                </button>
              </div>
